...
// ------ Registradores ----------------
void Model::registraRegistrador(Registradores *r) { Reg = r; }

void Model::removeRegistrador() { Reg = NULL; }
...
// -------- FR -----------
bool Model::getFR(int N) { return FR[N]; }
...
// ------ Instrucoes -------------------
void Model::registraInstrucoes(Instrucoes *i) { Ins = i; }

void Model::removeInstrucoes() { Ins = NULL; }

void Model::setProcessamento(bool automatico) { this->automatico = automatico; }

bool Model::getProcessamento() { return automatico; }
...
// ------ Video -------------------
void Model::registraVideo(Video *v) { Vid = v; }

void Model::removeVideo() { Vid = NULL; }

short int** Model::getChars() { return chars; }

pixblock* Model::getPixblock() { return block; }
...
char* Model::getCharmap() { return charmap; }

char* Model::getCpuram() { return cpuram; }

int Model::getCharmapdepth() { return charmapdepth; }

int Model::getCharmapwidth() { return charmapwidth; }


// Memoria
int Model::getMem(int pos) { return mem[pos]; }
